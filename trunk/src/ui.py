...
_(" Apply Changes")
_("<b>Default archive type</b>")
_("<b>Default font folder</b>")
_("<b>Fonts not present in user collections</b>")
_("<b>Select directories to scan for fonts</b>")
...
<interface>
  ...
  <object class="GtkWindow" id="window">
    ...
    <child>
      <object class="GtkNotebook" id="notebook">
        ...
        <child>
          <object class="GtkVBox" id="folder_opts_box">
            <property name="visible">True</property>
            <property name="border_width">7</property>
            <property name="orientation">vertical</property>
            <child>
              <object class="GtkFrame" id="folders_frame">
                <property name="visible">True</property>
                ...
                <child>
                  <object class="GtkAlignment" id="align1">
                    ...
                    <child>
                      <object class="GtkHBox" id="folder_view_box">
                        <property name="visible">True</property>
                        <property name="border_width">7</property>
                        <child>
                          <object class="GtkScrolledWindow" id="scroll">
                            ...
                            <property name="shadow_type">etched-in</property>
                            <child>
                              <object class="GtkTreeView" id="user_dir_treeview">
                                <property name="visible">True</property>
                                <property name="can_focus">True</property>
                        ...
                        <child>
                          <object class="GtkVBox" id="dir_button_box">
                            <property name="visible">True</property>
                            <property name="border_width">7</property>
                            <property name="orientation">vertical</property>
                            <child>
                              <object class="GtkButton" id="add_dir">
                                <property name="visible">True</property>
                                <property name="can_focus">True</property>
                                ...
                                <property name="relief">half</property>
                                <property name="focus_on_click">False</property>
                                <signal name="clicked" handler="on_add_dir"/>
                              </object>
                              <packing>
                                <property name="fill">False</property>
                                <property name="position">0</property>
                            ...
                            <child>
                              <object class="GtkButton" id="del_dir">
                                <property name="visible">True</property>
                                <property name="can_focus">True</property>
                                <property name="receives_default">True</property>
                                <property name="border_width">2</property>
                                <property name="image">del_icon</property>
                                <property name="relief">half</property>
                                <property name="focus_on_click">False</property>
                                <signal name="clicked" handler="on_del_dir"/>
                              </object>
                              <packing>
                                <property name="fill">False</property>
                                <property name="position">2</property>
                ...
                <child type="label">
                  <object class="GtkLabel" id="label1">
                    ...
                    <property name="label" translatable="yes">&lt;b&gt;Select directories to scan for fonts&lt;/b&gt;</property>
            ...
            <child>
              <object class="GtkFrame" id="def_folder_frame">
                <property name="visible">True</property>
                <property name="label_xalign">0</property>
                <property name="shadow_type">none</property>
                <child>
                  <object class="GtkAlignment" id="align2">
                    <property name="visible">True</property>
                    <property name="left_padding">22</property>
                    <property name="right_padding">22</property>
                    <child>
                      <object class="GtkVBox" id="default_folder_box">
                        <property name="visible">True</property>
                        <property name="orientation">vertical</property>
                        <child>
                          <placeholder/>
                ...
                <child type="label">
                  <object class="GtkLabel" id="label2">
                    <property name="visible">True</property>
                    <property name="ypad">10</property>
                    <property name="label" translatable="yes">&lt;b&gt;Default font folder&lt;/b&gt;</property>
                    <property name="use_markup">True</property>
                  </object>
                </child>
              </object>
            ...
            <child>
              <object class="GtkHBox" id="folder_apply_box">
                <property name="visible">True</property>
                <property name="border_width">7</property>
                <property name="homogeneous">True</property>
                <child>
        ...
        <child type="tab">
          <object class="GtkLabel" id="folder_tab">
            <property name="visible">True</property>
        ...
        <child>
          <object class="GtkVBox" id="collection_opts_box">
            <property name="visible">True</property>
            <property name="border_width">7</property>
            <property name="orientation">vertical</property>
            <child>
              <object class="GtkFrame" id="orphans_frame">
                <property name="visible">True</property>
                <property name="label_xalign">0</property>
                <property name="shadow_type">none</property>
                <child>
                  <object class="GtkAlignment" id="align3">
                    <property name="visible">True</property>
                    <property name="left_padding">12</property>
                    <child>
                      <object class="GtkCheckButton" id="show_orphans">
                        <property name="label" translatable="yes">Show Orphans</property>
                        <property name="visible">True</property>
                        <property name="can_focus">True</property>
                        <property name="receives_default">False</property>
                        <property name="active">True</property>
                ...
                <child type="label">
                  <object class="GtkLabel" id="label3">
                    <property name="visible">True</property>
                    <property name="ypad">10</property>
                    <property name="label" translatable="yes">&lt;b&gt;Fonts not present in user collections&lt;/b&gt;</property>
                    <property name="use_markup">True</property>
                  </object>
                </child>
              </object>
            ...
            <child>
              <object class="GtkFrame" id="arch_frame">
                <property name="visible">True</property>
                <property name="label_xalign">0</property>
                <property name="shadow_type">none</property>
                <child>
                  <object class="GtkAlignment" id="align4">
                    <property name="visible">True</property>
                    <property name="left_padding">22</property>
                    <property name="right_padding">22</property>
                    <child>
                      <object class="GtkVBox" id="arch_box">
                        <property name="visible">True</property>
                        <property name="orientation">vertical</property>
                        <child>
                          <placeholder/>
                ...
                <child type="label">
                  <object class="GtkLabel" id="label4">
                    <property name="visible">True</property>
                    <property name="ypad">10</property>
                    <property name="label" translatable="yes">&lt;b&gt;Default archive type&lt;/b&gt;</property>
                    <property name="use_markup">True</property>
                  </object>
                </child>
              </object>
            ...
            <child>
              <object class="GtkHBox" id="collections_apply_box">
                <property name="visible">True</property>
                <property name="border_width">7</property>
                <property name="homogeneous">True</property>
                <child>
                ...
                <child>
                  <object class="GtkButton" id="apply1">
                    <property name="label" translatable="yes"> Apply Changes</property>
                    <property name="visible">True</property>
                    <property name="can_focus">True</property>
                    <property name="receives_default">True</property>
                    <property name="image">apply_icon1</property>
                    <property name="image_position">right</property>
                    <signal name="clicked" handler="on_apply"/>
                  </object>
                  <packing>
        ...
        <child type="tab">
          <object class="GtkLabel" id="collections_tab">
            <property name="visible">True</property>
            <property name="label" translatable="yes">Collection Options</property>
          </object>
          <packing>
            <property name="position">1</property>
            <property name="tab_fill">False</property>
  ...
  <object class="GtkImage" id="apply_icon1">
    <property name="visible">True</property>
  ...
  <object class="GtkImage" id="del_icon">
    <property name="visible">True</property>
    <property name="stock">gtk-remove</property>
    <property name="icon-size">1</property>
  </object>
