...
{
    TestDialog *dialog = test_dialog_new(parent, "Category Selection", 950, 550);
    ...
    g_object_bind_property(categories, "selected-item", fontlist, "filter", G_BINDING_SYNC_CREATE);
