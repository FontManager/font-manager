...
{
    GtkFileChooserNative *dialog = font_manager_file_selector_get_executable(parent);
...
{
    GtkMessageDialog *dialog = font_manager_progress_dialog_create(parent, "Testing Progress Dialog");
