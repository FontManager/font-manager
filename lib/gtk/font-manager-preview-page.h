...
gchar * font_manager_preview_page_get_font_description (FontManagerPreviewPage *self);
...
void font_manager_preview_page_set_font_description (FontManagerPreviewPage *self, const gchar *font);
