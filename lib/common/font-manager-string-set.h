...
void font_manager_string_set_add_all (FontManagerStringSet *self, GList *add);
gboolean font_manager_string_set_contains (FontManagerStringSet *self, const gchar *str);
gboolean font_manager_string_set_contains_all (FontManagerStringSet *self, GList *contents);
void font_manager_string_set_remove (FontManagerStringSet *self, const gchar *str);
void font_manager_string_set_remove_all (FontManagerStringSet *self, GList *remove);
void font_manager_string_set_retain_all (FontManagerStringSet *self, GList *retain);
