/* FontManager.vapi generated by vapigen-0.44, do not modify. */

[CCode (cprefix = "FontManager", gir_namespace = "FontManager", gir_version = "0.7.4.3", lower_case_cprefix = "font_manager_")]
namespace FontManager {
	...
	public static GLib.List<unichar>? get_charset_from_filepath (string filepath, int index);
	[CCode (cheader_filename = "font-manager-fontconfig.h", cname = "get_charset_from_font_object")]
	public static GLib.List<unichar>? get_charset_from_font_object (Json.Object font_object);
