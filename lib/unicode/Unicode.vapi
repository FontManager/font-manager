/* Unicode-0.7.8.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "Unicode", gir_namespace = "Unicode", gir_version = "0.7.8", lower_case_cprefix = "unicode_")]
namespace Unicode {
    ...
    public class SearchBar : Gtk.SearchBar, Atk.Implementor, Gtk.Buildable {
        ...
        public SearchBar ();
        [NoAccessorMethod]
        public GLib.Object charmap { owned get; set; }
    }
